...
RUN export current=$(pwd); cd /miniconda/lib/$(ls /miniconda/lib | grep ^python)/site-packages/mlflow/models/container/scoring_server ; curl nginx_file > nginx.conf; cd $current
